...
const imgBtn9 = document.querySelector('.img-btn9')
imgBtn9.addEventListener('click', loadImage)

const imgBtn10 = document.querySelector('.img-btn10')
imgBtn10.addEventListener('click', loadImage)
